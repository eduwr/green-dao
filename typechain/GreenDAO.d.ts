...
interface GreenDAOInterface extends ethers.utils.Interface {
  functions: {
...
export class GreenDAO extends BaseContract {
  ...
  functions: {
    ...
    nameExists(arg0: string, overrides?: CallOverrides): Promise<[boolean]>;
  ...
  callStatic: {
    ...
    mint(_name: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    nameExists(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
